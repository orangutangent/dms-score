...
const ScoreTable: React.FC<ScoreTableProps> = ({ scores, criteria, averageScore, getMaturityStage }) => {
  return (
    <div>
      ...
      <div className="mt-4 space-y-4">
        {Object.entries(criteria).map(([criterion, { color, weight }]) => {
          ...
          const criterionAverage = weight > 0 ? score / weight : 0;
          const stage = getMaturityStage(criterionAverage);
