...
import questionsData from '../../govermentsmi.json';

const questions: QuestionType[] = questionsData as QuestionType[];

const GovermentsMiPage = () => {
  const {
    currentQuestion,
    ...
    progress,
    initialAnswer,
  } = useSurvey('govermentsmi', questions, '/resultsgovermentserice');
...
export default GovermentsMiPage;
